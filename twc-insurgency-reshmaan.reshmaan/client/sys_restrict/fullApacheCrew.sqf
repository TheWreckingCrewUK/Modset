...
while {!isPlayer P507 || !isPlayer P508}do{
    [
        "<t size='1.2'>Apache Crew</t><br/><t size='0.6'>You need all 2 members of the Armour Crew to be in game before you can proceed.</t>", 0, 0.22, 5, 0, 0, 2
