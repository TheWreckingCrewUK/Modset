...
if (_civilianQuestioned in nonQuestionableList) then {
	...
	if (_givenNumber == 0) then {
		...
		switch (True) do {
			...
			case (floor InsP_civTrust == -1):{hintSilent "I can't help you. Leave our villlage. Haran!"};
			...
			case (floor InsP_civTrust == 2):{hintSilent "I wish I could help, but I don't know anyhing."};
