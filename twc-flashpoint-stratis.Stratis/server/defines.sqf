markerArray = ["aa1","airbase2","hq1","inf1","inf2","inf3","inf4","mainHQ","mech1","motorized1","outpost1","outpost2","outpost3","radar1","support1"];
...
if(isNil "remainingArray") then{
	remainingArray = ["aa1","airbase2","hq1","inf1","inf2","inf3","inf4","mainHQ","mech1","motorized1","outpost1","outpost2","outpost3","radar1","support1"];
