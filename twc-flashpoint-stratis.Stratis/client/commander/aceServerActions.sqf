...
twc_fnc_captureOutpost3 = {
	_trig = nearestObject [getMarkerPos "outpost3", "emptydetector"];
	deleteVehicle _trig;
	["outpost3",false] remoteExec ["twc_siteCapturedBlufor",2];
};
...
captureOutpost3Action = ["captureOutpost3","Outpost3","", {call twc_fnc_captureOutpost3;},{true}] call ace_interact_menu_fnc_createAction;
...
[player, 1, ["ACE_SelfActions", "thisStartsTheServer", "thisStartsTheSites1"], captureMainHQAction] call ace_interact_menu_fnc_addActionToObject;
...
[player, 1, ["ACE_SelfActions", "thisStartsTheServer", "thisStartsTheSites2"], captureOutpost3Action] call ace_interact_menu_fnc_addActionToObject;
