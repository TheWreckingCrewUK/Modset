...
_specialSlots = ["P38", "P39","tank1","tank2","tank3","humanCiv1","humanCiv2","humanCiv3","p33","p34","p36","p37"];
...
if ((str player) in _specialSlots)then{
	...
	if((_UID) != "_SP_PLAYER_")then{	
		...
		if ((str player) in _Sniperteam && (count playableUnits) < _numPlayers) then {
