[] spawn {
	...
	_View_distance_setup = ['TWC_Viewdistance','View Distance','',CHVD_fnc_openDialog,{true}] call ace_interact_menu_fnc_createAction;
    [player, 1, ["ACE_SelfActions"], _View_distance_setup] call ace_interact_menu_fnc_addActionToObject;

  // id_veiw_distance = ["View Distance Settings", {true}, CHVD_fnc_openDialog, true] call AGM_Interaction_fnc_addInteractionSelf;
