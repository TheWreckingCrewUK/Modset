...
class CfgSounds {
	...
	class TWC_sound_allclearvoice {
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\allclearvoice.wav", db+28, 1, 400};
		titles[] = {0, ""};
	};
	...
	class TWC_sound_contactvoice {
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\contactvoice.wav", db+28, 1, 400};
		titles[] = {0, ""};
	};
	...
	class TWC_sound_incomingvoice1 {
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\incomingvoice1.wav", db+28, 1, 400};
		titles[] = {0, ""};
	};
	...
	class TWC_sound_incomingvoice2 {
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\incomingvoice2.wav", db+28, 1, 400};
		titles[] = {0, ""};
	};
	...
	class TWC_sound_incomingvoice3 {
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\incomingvoice3.ogg", db+28, 1, 400};
		titles[] = {0, ""};
	};
	...
	class TWC_sound_standtovoice {
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\standtovoice.wav", db+28, 1, 400};
		titles[] = {0, ""};
	};
	...
	class TWC_sound_idfclear {
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\down01.ogg", db+28, 1, 400};
		titles[] = {0, ""};
	};
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\down02.ogg", db+28, 1, 400};
		titles[] = {0, ""};
	};
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\down03.ogg", db+28, 1, 400};
		titles[] = {0, ""};
	};
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\down04.ogg", db+28, 1, 400};
		titles[] = {0, ""};
	};
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\down05.ogg", db+28, 1, 400};
		titles[] = {0, ""};
	};
		...
		// filename, volume, pitch, distance
		sound[] = {"\twc_basedefence\sounds\down06.ogg", db+28, 1, 400};
		titles[] = {0, ""};
	};
};