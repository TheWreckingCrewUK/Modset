...
class UK3CB_BAF_LandRover_Hard_Base: UK3CB_BAF_LandRover_Base
	{
		...
		class EventHandlers: EventHandlers {
			init = " if (!isServer) exitWith {};			_car = (_this select 0);	 _obj = 'TWC_Public_AmmoBox_Hobbs_Precious' createvehicle [0,0,0];  _obj attachto [_car, [-0.9,-0.3,-1.15]];   _obj setVectorDirAndUp [[0,1,0],[1,0,0]]; 		 _obj = 'TWC_Public_AmmoBox_Hobbs_Precious' createvehicle [0,0,0];  _obj attachto [_car, [0.9,-0.35,-1.05]];   _obj setVectorDirAndUp [[0,1,0],[1,0,0]];	_car animate ['sparewheel_hide', 1];		_obj = 'ace_wheel' createvehicle [0,0,0];  _obj attachto [_car, [-1.05,-0.25,-0.35]];   _obj setVectorDirAndUp [[0.1,0,1],[0,0,1]]; 	";
...
class UK3CB_BAF_Coyote_L111A1_Base_D: UK3CB_BAF_Jackal_Base_D 
	{
		...
		class EventHandlers: EventHandlers {
			init = " if (!isServer) exitWith {};			_car = (_this select 0);	 _obj = 'TWC_Public_AmmoBox_Hobbs_Precious' createvehicle [0,0,0];  _obj attachto [_car, [0.9,1.0,-1.5]];   _obj setVectorDirAndUp [[0,0,1],[1,0,0]]; 	 _obj = 'TWC_Public_AmmoBox_Hobbs_Precious' createvehicle [0,0,0];  _obj attachto [_car, [-0.8,1.0,-1.5]];   _obj setVectorDirAndUp [[0,0,1],[1,0,0]]; ";
...
class UK3CB_BAF_Jackal2_L111A1_Base_D: UK3CB_BAF_Coyote_L111A1_Base_D
	{
		...
		class EventHandlers: EventHandlers {
			init = " if (!isServer) exitWith {};			_car = (_this select 0);	 _obj = 'TWC_Public_AmmoBox_Hobbs_Precious' createvehicle [0,0,0];  _obj attachto [_car, [-1,0.3,-1.5]];   _obj setVectorDirAndUp [[0,0,1],[1,0,0]]; 	 _obj = 'TWC_Public_AmmoBox_Hobbs_Precious' createvehicle [0,0,0];  _obj attachto [_car, [0.7,0.3,-1.5]];   _obj setVectorDirAndUp [[0,0,1],[1,0,0]]; ";
