...
class CfgEditorSubcategories {
	...
	class TWC_Crates_UNSC {
		displayName = "UNSC Ammo Crates";
	};
};
...
class CfgVehicles
{
	...
	class OPTRE_Spartan3_Soldier;

	#define MEDICAL_LOADOUT "ACRE_PRC148","ACE_EarPlugs","ACE_fieldDressing","ACE_fieldDressing","ACE_fieldDressing","ACE_fieldDressing","ACE_fieldDressing","ACE_fieldDressing","ACE_packingBandage","ACE_packingBandage","ACE_packingBandage","ACE_packingBandage","ACE_packingBandage","ACE_packingBandage","ACE_elasticBandage","ACE_elasticBandage","ACE_elasticBandage","ACE_elasticBandage","ACE_elasticBandage","ACE_elasticBandage","ACE_quikclot","ACE_quikclot","ACE_quikclot","ACE_quikclot","ACE_quikclot","ACE_morphine","ACE_morphine","ACE_epinephrine","ACE_tourniquet","ACE_tourniquet"
	#define MAG_2(a) a, a
	...
	class TWC_Infantry_Spartan_Base: OPTRE_Spartan3_Soldier
	{
		scope = 1;
