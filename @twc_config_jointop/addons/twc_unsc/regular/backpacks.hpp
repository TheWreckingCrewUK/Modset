...
class TWC_Backpack_Spartan_TeamLeader: OPTRE_ANPRC_521_Black_Spartan
{
	...
	class TransportMagazines {
		...
		ADD_MAGA(SmokeShellRed,2);
		ADD_MAGA(SmokeShellBlue,2);
		ADD_MAGA(OPTRE_60Rnd_762x51_Mag,6);
		ADD_MAGA(OPTRE_4Rnd_145x114_APFSDS_Mag,5);
		ADD_MAGA(1Rnd_HE_Grenade_shell,10);
		ADD_MAGA(OPTRE_12Rnd_8Gauge_Pellets,3);
		ADD_MAGA(OPTRE_12Rnd_8Gauge_Slugs,3);
		ADD_MAGA(OPTRE_200Rnd_127x99_M247H_Etilka_Ball,1);
	};
};
...
class TWC_Backpack_Spartan_AT: OPTRE_ILCS_Rucksack_Heavy_Spartan
{
	...
	class TransportMagazines {
		ADD_MAGA(OPTRE_M41_Twin_HEAP,1);
		ADD_MAGA(OPTRE_M41_Twin_HEAT,2);
		ADD_MAGA(OPTRE_60Rnd_762x51_Mag,3);
	};
};

class TWC_Backpack_Spartan_Breacher: OPTRE_ILCS_Rucksack_Heavy_Spartan
{
	scope = 1;
	scopeArsenal = 1;
	class TransportWeapons {
		ADD_WEAP(TWC_Weapon_MA5B,1);
	};
};
class TWC_Backpack_Spartan_PlatoonCommander: OPTRE_ANPRC_521_Black_Spartan
{
	scope = 1;
	scopeArsenal = 1;
	class TransportItems {
...
class TWC_Backpack_Spartan_PlatoonMedic: OPTRE_ILCS_Rucksack_Heavy_Spartan
{
	scope = 1;
	scopeArsenal = 1;
	class TransportItems {
