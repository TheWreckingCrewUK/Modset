...
if (isServer) then 
{
	...
	if ("" isEqualTo _type_plane && "" isEqualTo _type_cargo) then 
	{
		switch (_Plane_Units) do
		{
			...
			case ("Cold_VDV"): {_type_plane = "cwr3_o_an12_unarmed"; _type_cargo = ["BCCCCP_VDV_Squadlead_Para", "BCCCCP_VDV_MG_RPK_Para", "BCCCCP_VDV_Grenadier_Para", "BCCCCP_VDV_GrenadierAss_Para", "BCCCCP_VDV_Rifleman_Para", "BCCCCP_VDV_Rifleman_Para", "BCCCCP_VDV_Rifleman_Para", "BCCCCP_VDV_Rifleman_Para", "BCCCCP_VDV_SenRifleman_Para"]; _side = 0;};
			case ("Modern_VDV"): {_type_plane = "cwr3_o_an12_unarmed"; _type_cargo = ["CUP_O_RU_Soldier_SL_VDV_EMR", "CUP_O_RU_Soldier_MG_VDV_EMR", "CUP_O_RU_Soldier_AT_VDV_EMR", "CUP_O_RU_Soldier_LAT_VDV_EMR", "CUP_O_RU_Soldier_GL_VDV_EMR", "CUP_O_RU_Soldier_Marksman_VDV_EMR", "CUP_O_RU_Soldier_MG_VDV_EMR", "CUP_O_RU_Soldier_AT_VDV_EMR", "CUP_O_RU_Soldier_AR_VDV_EMR", "CUP_O_RU_Soldier_LAT_VDV_EMR", "CUP_O_RU_Soldier_GL_VDV_EMR", "CUP_O_RU_Soldier_VDV_EMR"]; _side = 0;};
