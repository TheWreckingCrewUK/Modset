...
[(_logic getVariable "boatSafety")] call twc_framework_fnc_toggleBoatSafety;
...
if (!hasInterface) then {
	[(_logic getVariable "civilianEquipment")] call twc_framework_fnc_cleanCivilianEquipment;
	[(_logic getVariable "deadBodies")] call twc_framework_fnc_cleanBaseBodies;
};
