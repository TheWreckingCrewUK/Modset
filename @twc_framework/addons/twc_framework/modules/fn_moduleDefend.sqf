...
[{
	params ["_units","_pos","_radius","_size","_patrol"];
	{ [_x,_pos,_radius,_size,_patrol] call twc_fnc_defend; } forEach _units;
}, [_units,_pos,_radius,_size,_patrol], 0.05] call CBA_fnc_waitAndExecute;
