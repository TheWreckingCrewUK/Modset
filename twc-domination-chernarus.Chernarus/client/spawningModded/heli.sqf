...
heliSpawner addAction ["Spawn UH60M Blackhawk",
	{_veh = nearestObject [getPos heliSpawnPad, "air"]; deleteVehicle _veh; _dir = getDir heliSpawnPad; _dir = _dir + 180; _veh = "CUP_B_UH60M_US" createVehicle (getPos heliSpawnpad); _veh setPos (getPos heliSpawnPad); _veh setDir _dir;
