[arsenalAmmoBox,["rhs_weap_m4a1_carryhandle_m203","rhsusf_weap_m1911a1","ACE_Vector","UK3CB_BAF_AT4_AP_Launcher"],false] call BIS_fnc_addVirtualWeaponCargo;
[arsenalAmmoBox,["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag_Tracer_Red","rhsusf_mag_7x45acp_MHP","NLAW_F","1Rnd_HE_Grenade_shell","UGL_FlareWhite_F","1Rnd_Smoke_Grenade_shell"],false] call BIS_fnc_addVirtualMagazineCargo;
[arsenalAmmoBox,["rhsusf_ach_helmet_ESS_ocp","rhs_uniform_cu_ocp","rhsusf_iotv_ocp_SAW","acc_pointer_IR","UK3CB_BAF_TA31F_3D","ACRE_PRC148"],false] call Bis_fnc_addVirtualItemCargo;
