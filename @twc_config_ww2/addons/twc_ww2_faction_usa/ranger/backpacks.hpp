...
class TWC_Backpack_WW2_US_Ranger_Rifleman: B_LIB_US_M36_Bandoleer {
	scope = 1;
	scopeArsenal = 1;
...
class TWC_Backpack_WW2_US_Ranger_Grenadier: B_LIB_US_M36_Bandoleer {
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
		ADD_MAGA(LIB_8Rnd_762x63, 12);
...
class TWC_Backpack_WW2_US_Ranger_SMG: B_LIB_US_M36_Rope {
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
...
class TWC_Backpack_WW2_US_Ranger_MG: B_LIB_US_M36_Rope {
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
...
class TWC_Backpack_WW2_US_Ranger_MGASS: B_LIB_US_M36_Rope {
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
...
class TWC_Backpack_WW2_US_Ranger_Ammobearer: B_LIB_US_M36_Bandoleer {
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
		ADD_MAGA(LIB_8Rnd_762x63, 12);
...
class TWC_Backpack_WW2_US_Ranger_2iC: B_LIB_US_M36_Bandoleer {
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
...
class TWC_Backpack_WW2_US_Ranger_SquadLeader: B_LIB_US_M36_Rope {
	scope = 1;
	scopeArsenal = 1;
	maximumLoad = 180;
	class TransportMagazines {
...
class TWC_Backpack_WW2_US_Ranger_Platoon_Leader: B_LIB_US_M36_Rope {
	scope = 1;
	scopeArsenal = 1;
	maximumLoad = 180;
	class TransportMagazines {
