class TWC_Infantry_WW2_US_Ranger_Woodland_Rifleman: TWC_Infantry_WW2_USA_Base {
	...
	backpack = "TWC_Backpack_WW2_US_Ranger_Rifleman";
	linkedItems[] =
	{
...
class TWC_Infantry_WW2_US_Ranger_Woodland_Scout: TWC_Infantry_WW2_US_Ranger_Woodland_Rifleman {
	displayName = "Scout";
};
class TWC_Infantry_WW2_US_Ranger_Woodland_Grenadier: TWC_Infantry_WW2_US_Ranger_Woodland_Rifleman{
	displayName = "Grenadier";
	backpack = "TWC_Backpack_WW2_US_Ranger_Grenadier";
	linkedItems[] =
	{
...
class TWC_Infantry_WW2_US_Ranger_Woodland_SMG: TWC_Infantry_WW2_US_Ranger_Woodland_Rifleman {
	...
	backpack = "TWC_Backpack_WW2_US_Ranger_SMG";
	linkedItems[] =
	{
...
class TWC_Infantry_WW2_US_Ranger_Woodland_MG: TWC_Infantry_WW2_US_Ranger_Woodland_SMG {
	...
	backpack = "TWC_Backpack_WW2_US_Ranger_MG";
	linkedItems[] =
	{
...
class TWC_Infantry_WW2_US_Ranger_Woodland_MGASS: TWC_Infantry_WW2_US_Ranger_Woodland_SMG {
	...
	backpack = "TWC_Backpack_WW2_US_Ranger_MGASS";
	linkedItems[] =
	{
...
class TWC_Infantry_WW2_US_Ranger_Woodland_2iC: TWC_Infantry_WW2_US_Ranger_Woodland_Rifleman {
	displayName = "Assistant Squad Leader";
	TWC_isCommandRole = 1;
	uniformClass = "U_LIB_US_AB_Uniform_M42_corporal";
	backpack = "TWC_Backpack_WW2_US_Ranger_2iC";
	linkedItems[] =
	{
		"V_LIB_US_AB_Vest_Carbine",
...
class TWC_Infantry_WW2_US_Ranger_Woodland_SquadLeader: TWC_Infantry_WW2_US_Ranger_Woodland_SMG {
	...
	backpack = "TWC_Backpack_WW2_US_Ranger_SquadLeader";
	linkedItems[] =
	{
...
class TWC_Infantry_WW2_US_Ranger_Woodland_Platoon_Leader: TWC_Infantry_WW2_US_Ranger_Woodland_SquadLeader {
	...
	backpack = "TWC_Backpack_WW2_US_Ranger_Platoon_Leader";
...
class TWC_Infantry_WW2_US_Ranger_Woodland_Platoon_Sergeant: TWC_Infantry_WW2_US_Ranger_Woodland_Platoon_Leader {
