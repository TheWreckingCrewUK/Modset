...
//SECTION, DISMOUNTED
class TWC_Backpack_WW2_UK_Early_Dismounted_Rifleman: B_LIB_UK_HSack_Tea
{
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
...
class TWC_Backpack_WW2_UK_Early_Dismounted_MGASS: B_LIB_UK_HSack_Tea
{
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
...
//PLATOON
class TWC_Backpack_WW2_UK_Early_Platoon_Commander: B_LIB_UK_HSack_Tea
{
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
...
class TWC_Backpack_WW2_UK_Early_Platoon_Mortar: B_LIB_UK_HSack_Tea
{
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
...
//PLATOON, DISMOUNTED
class TWC_Backpack_WW2_UK_Early_Dismounted_Platoon_Commander: B_LIB_UK_HSack_Tea
{
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
...
class TWC_Backpack_WW2_UK_Early_Dismounted_Platoon_Mortar: fow_b_uk_bergenpack
{
	scope = 1;
	scopeArsenal = 1;
	class TransportMagazines {
...
class TWC_Backpack_WW2_UK_Early_FO: B_LIB_US_Radio_ACRE2
{
	scope = 1;
	scopeArsenal = 1;
	class TransportItems {
...
//Aircraft
class TWC_Backpack_WW2_UK_Early_FAC: B_LIB_US_Radio_ACRE2
{
	scope = 1;
	scopeArsenal = 1;
	class TransportItems {
