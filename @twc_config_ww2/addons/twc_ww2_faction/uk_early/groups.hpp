#define EARLY_GROUPS(CAMO,ERA) \
class TWC_Groups_##ERA##_##CAMO \
{ \
	name = __EVAL("Infantry (Early, " + #CAMO + ")"); \
	class Section \
	{ \
		name = "Section"; \
		faction = "TWC_WW2"; \
...
{ \
	name = __EVAL("Infantry (Early, Dismounted, " + #CAMO + ")"); \
	class Section \
	{ \
		name = "Section"; \
		faction = "TWC_WW2"; \
...
EARLY_GROUPS(Woodland,WW2_UK_Early)
EARLY_GROUPS(Desert,WW2_UK_Early)
EARLY_GROUPS(Arctic,WW2_UK_Early)
EARLY_GROUPS(Tropic,WW2_UK_Early)