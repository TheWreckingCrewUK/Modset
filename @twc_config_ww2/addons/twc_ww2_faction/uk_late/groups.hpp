...
{ \
	...
	{ \
		...
		{ \
			side = 2; \
			vehicle = TWC_Infantry_##ERA##_##CAMO##_PIAT_Gunner; \
			rank = "PRIVATE"; \
			position[] = {2,0,0}; \
		}; \
		class Unit2 \
		{ \
			side = 2; \
			vehicle = TWC_Infantry_##ERA##_##CAMO##_PIAT_Ass; \
			rank = "PRIVATE"; \
			position[] = {4,0,0}; \
		}; \
	}; \
...
{ \
	name = __EVAL("Infantry (Late, Dismounted, " + #CAMO + ")"); \
	class Section \
	{ \
		name = "Section"; \
		faction = "TWC_WW2"; \
...
LATE_GROUPS(Woodland,WW2_UK_Late)
LATE_GROUPS(Desert,WW2_UK_Late)
LATE_GROUPS(Arctic,WW2_UK_Late)
LATE_GROUPS(Tropic,WW2_UK_Late)