...
_player1 = if(isNil "mert_sl")then{""}else{if(!isPlayer mert_sl)then{""}else{(name mert_sl)};};
_player2 = if(isNil "mert_med")then{""}else{if(!isPlayer mert_med)then{""}else{(name mert_med)};};
_player3 = if(isNil "mert_helo")then{""}else{if(!isPlayer mert_helo)then{""}else{(name mert_helo)};};
