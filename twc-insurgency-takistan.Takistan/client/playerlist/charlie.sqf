...
_player18 = if(isNil "p18")then{""}else{if(!isPlayer p18)then{""}else{(name p18)};};
_player19 = if(isNil "p19")then{""}else{if(!isPlayer p19)then{""}else{(name p19)};};
_player20 = if(isNil "p20")then{""}else{if(!isPlayer p20)then{""}else{(name p20)};};
_player21 = if(isNil "p21")then{""}else{if(!isPlayer p21)then{""}else{(name p21)};};
_player22 = if(isNil "p22")then{""}else{if(!isPlayer p22)then{""}else{(name p22)};};
_player23 = if(isNil "p23")then{""}else{if(!isPlayer p23)then{""}else{(name p23)};};
_player24 = if(isNil "p24")then{""}else{if(!isPlayer p24)then{""}else{(name p24)};};
_player25 = if(isNil "p25")then{""}else{if(!isPlayer p25)then{""}else{(name p25)};};
_player26 = if(isNil "p26")then{""}else{if(!isPlayer p26)then{""}else{(name p26)};};
_player27 = if(isNil "p27")then{""}else{if(!isPlayer p27)then{""}else{(name p27)};};
_player28 = if(isNil "p28")then{""}else{if(!isPlayer p28)then{""}else{(name p28)};};
_player29 = if(isNil "p29")then{""}else{if(!isPlayer p29)then{""}else{(name p28)};};
_player30 = if(isNil "p30")then{""}else{if(!isPlayer p30)then{""}else{(name p30)};};
