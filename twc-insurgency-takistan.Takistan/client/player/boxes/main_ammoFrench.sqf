...
//class availible to French Rifleman Only
...
//load availible to French Grenadier Only
...
//load availbiel to French Automatic Rifleman Only
...
//load availible to French Medic only
