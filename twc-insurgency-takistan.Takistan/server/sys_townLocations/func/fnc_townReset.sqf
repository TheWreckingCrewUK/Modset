...
_trg setTriggerStatements ["(((objectParent (thisList call bis_fnc_selectRandom)) isKindOf 'air') || (getPosATL (thisList call bis_fnc_selectRandom)) select 2 < 25)",format["[(getPos thisTrigger),%1,[600,800],thisList] call twc_fnc_spawn2",_waves],""];