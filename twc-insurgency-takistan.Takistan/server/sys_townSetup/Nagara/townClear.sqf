...
nurcolortrig = createTrigger ["EmptyDetector", getMarkerPos "Nagara"];
nurcolortrig setTriggerArea [500, 500, 0, false];
nurcolortrig setTriggerActivation ["East", "PRESENT", True];
nurcolortrig setTriggerStatements ["this", "'Nur' setMarkerColor 'Default'", "'Nagara' SetMarkerColor 'ColorWest'"
];