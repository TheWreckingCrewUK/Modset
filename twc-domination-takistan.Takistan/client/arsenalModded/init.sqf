...
[arsenalAmmoBox,["ItemMap","ItemCompass","ItemWatch","ACE_IR_Strobe_Item","ACE_CableTie","ACE_Flashlight_XL50","ACE_EarPlugs","ACE_MapTools","ACE_fieldDressing","ACE_elasticBandage","ACE_quikclot","ACE_packingBandage","ACE_morphine","ACE_tourniquet","rhsusf_ANPVS_14"],false] call Bis_fnc_addVirtualItemCargo;

if (!isNil "armour1" && {player == armour1}) then {
	execVM "client\arsenalModded\armour_co.sqf";
	//execVM "client\spawningModded\armour.sqf";	
...
if (!isNil "armour2" && {player == armour2}) then {
	execVM "client\arsenalModded\armour_cr.sqf";
...
if (!isNil "helo2" && {player == helo2}) then {
	execVM "client\arsenalModded\helo2.sqf";
	//execVM "client\spawningModded\heli.sqf";
};
if (!isNil "helo3" && {player == helo3}) then {
	execVM "client\arsenalModded\helo3.sqf";
	//execVM "client\spawningModded\heli.sqf";
};

if (!isNil "jet1" && {player == jet1}) then {
	execVM "client\arsenalModded\jet.sqf";
	//execVM "client\spawningModded\jet.sqf";
};
if (!isNil "p1" && {player == p1}) then {
	execVM "client\arsenalModded\alpha_sl.sqf";
...
if (!isNil "p2" && {player == p2}) then {
	execVM "client\arsenalModded\alpha_rf.sqf";
...
if (!isNil "p3" && {player == p3}) then {
	execVM "client\arsenalModded\alpha_grn.sqf";
...
if (!isNil "p4" && {player == p4}) then {
	execVM "client\arsenalModded\alpha_ar.sqf";
...
if (!isNil "p5" && {player == p5}) then {
	execVM "client\arsenalModded\alpha_2ic.sqf";
...
if (!isNil "p6" && {player == p6}) then {
	execVM "client\arsenalModded\alpha_mg.sqf";
...
if (!isNil "p7" && {player == p7}) then {
	execVM "client\arsenalModded\alpha_mark.sqf";
...
if (!isNil "p8" && {player == p8}) then {
	execVM "client\arsenalModded\alpha_med.sqf";
...
if (!isNil "p9" && {player == p9}) then {
	execVM "client\arsenalModded\bravo_sl.sqf";
...
if (!isNil "p10" && {player == p10}) then {
	execVM "client\arsenalModded\bravo_tl.sqf";
...
if (!isNil "p11" && {player == p11}) then {
	execVM "client\arsenalModded\bravo_rf.sqf";
...
if (!isNil "p12" && {player == p12}) then {
	execVM "client\arsenalModded\bravo_grn.sqf";
...
if (!isNil "p13" && {player == p13}) then {
	execVM "client\arsenalModded\bravo_ar.sqf";
...
if (!isNil "p16" && {player == p16}) then {
	execVM "client\arsenalModded\bravo_mark.sqf";
...
if (!isNil "p17" && {player == p17}) then {
	execVM "client\arsenalModded\bravo_med.sqf";
...
if (!isNil "p18" && {player == p18}) then {
	execVM "client\arsenalModded\charlie_sl.sqf";
...
if (!isNil "p19" && {player == p19}) then {
	execVM "client\arsenalModded\charlie_tl.sqf";
...
if (!isNil "p20" && {player == p20}) then {
	execVM "client\arsenalModded\charlie_rf.sqf";
...
if (!isNil "p21" && {player == p21}) then {
	execVM "client\arsenalModded\charlie_ar.sqf";
...
if (!isNil "p22" && {player == p22}) then {
	execVM "client\arsenalModded\charlie_aar.sqf";
...
if (!isNil "p28" && {player == p28}) then {
	execVM "client\arsenalModded\charlie_mg.sqf";
...
if (!isNil "p29" && {player == p29}) then {
	execVM "client\arsenalModded\charlie_mgass.sqf";
...
if (!isNil "p30" && {player == p30}) then {
	execVM "client\arsenalModded\charlie_med.sqf";
