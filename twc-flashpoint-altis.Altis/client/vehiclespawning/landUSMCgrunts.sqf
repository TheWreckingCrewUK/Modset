...
SpawnHMMVUnarmedAction = ["SpawnHMMVUnarmed","HMMV Unarmed","",{["rhsusf_m998_w_4dr_fulltop"] spawn twc_fnc_spawnGroundVehicle},{TRUE}] call ace_interact_menu_fnc_createAction;
