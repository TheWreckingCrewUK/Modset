...
SpawnHemTTCommandAction = ["SpawnHemTTCommand","HemTT Command","",{_veh = "B_Truck_01_medical_F" createVehicle (position jetSpawnPad);_dir = getDir jetSpawnPad; _dir = _dir + 180; _veh setDir _dir; [_veh, 180, 1200, 0, FALSE] execVM "server\vehicles\vehicleRespawn.sqf"},{TRUE}] call ace_interact_menu_fnc_createAction;
