...
_trg2 setTriggerArea [700, 700, 0, True];
_trg2 setTriggerActivation ["ANY", "PRESENT", true];
_trg2 setTriggerTimeout [120,120,30,True];
_trg2 setTriggerStatements ["(East countSide thisList) < 4 OR (West countSide thisList) == 0", format["['%1'] call twc_siteDeciding", _marker], ""];