...
_trg2 setTriggerStatements ["((EAST countSide thisList) < 4 && ({_x isKindOf 'landVehicle' && side _x == EAST} count thisList == 0)) OR (West countSide thisList) == 0", format["['%1', %2, thisList] call twc_siteDeciding", _marker, _canCounter], ""];