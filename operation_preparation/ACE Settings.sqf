...
ace_interact_menu_more__TWC_Gestures = false;
...
ace_interact_menu_moveToRoot__ACE_Equipment__TWC_Item_Markerlight_place = false;
ace_interact_menu_moveToRoot__ACE_Equipment__TWC_Map_Unfold = false;
...
ace_interact_menu_moveToRoot__TWC_Gestures__TWC_AI_Control_Gesture_Advance = false;
ace_interact_menu_moveToRoot__TWC_Gestures__TWC_AI_Control_Gesture_Halt = false;
ace_interact_menu_moveToRoot__TWC_Gestures__TWC_AI_Control_Surrender = false;
...
Achilles_var_african_units = true;
Achilles_var_afuk = true;
...
Achilles_var_cwr3_faction_rebels_east = true;
Achilles_var_cwr3_faction_rebels_west = true;
Achilles_var_cwr3_faction_rus = true;
Achilles_var_cwr3_faction_rus_des = true;
Achilles_var_cwr3_faction_uk = true;
Achilles_var_cwr3_faction_usa = true;
Achilles_var_cwr3_faction_usa_des = true;
...
Achilles_var_ira_units = true;
Achilles_var_Iraqi_units = true;
...
Achilles_var_PLA_UN_Faction = true;
...
Achilles_var_Russian_Federation = true;
...
Achilles_var_TWC_Afr_Pirates = true;
Achilles_var_TWC_Afr_Pirates_RF = true;
Achilles_var_TWC_Asn_Pirates = true;
Achilles_var_TWC_Asn_Pirates_RF = true;
Achilles_var_TWC_BLUFOR_Units_USA_1980 = true;
Achilles_var_TWC_CI_Units = true;
Achilles_var_TWC_ColdWar = true;
Achilles_var_TWC_Colombia = true;
Achilles_var_TWC_FARC_Units = true;
Achilles_var_TWC_General = true;
Achilles_var_TWC_GRUP_Units = true;
Achilles_var_TWC_IDF_ColdWar = true;
Achilles_var_TWC_IDF_Millenial = true;
Achilles_var_TWC_INDEP_Units_Aden = true;
Achilles_var_TWC_INDEP_Units_Argentina_1980 = true;
Achilles_var_TWC_Millennial = true;
Achilles_var_TWC_Modern = true;
Achilles_var_TWC_MTF_Units = true;
Achilles_var_TWC_OPFOR_BurIns = true;
Achilles_var_TWC_OPFOR_Taliban = true;
Achilles_var_TWC_OPFOR_Units_Aden = true;
Achilles_var_TWC_OPFOR_Units_CSLA = true;
Achilles_var_TWC_OPFOR_Units_Iraq = true;
Achilles_var_TWC_OPFOR_Units_LWP = true;
Achilles_var_TWC_OPFOR_Units_NVA = true;
Achilles_var_TWC_OPFOR_Units_PLO = true;
Achilles_var_TWC_PAVN = true;
Achilles_var_TWC_PLACW_Units = true;
Achilles_var_TWC_Tak_Civ = true;
Achilles_var_TWC_Training = true;
Achilles_var_TWC_USA_CW = true;
Achilles_var_TWC_USA_Modern = true;
Achilles_var_TWC_USMC_Modern = true;
Achilles_var_TWC_USSR_Afghan = true;
Achilles_var_TWC_WaPArmy_Taviana = true;
Achilles_var_TWC_WW2 = true;
