	...
	class TWC_Coin_Operation_Ammobox: CUP_BAF_VehicleBox
	{
		author="FakeMatty";
		displayName="TWC COIN Ammo Box";
		class TransportMagazines
		{
			class _xx_UK3CB_BAF_556_30Rnd
			{
	...
	class TWC_1990_Operation_Ammobox: CUP_BAF_VehicleBox
	{
		author="FakeMatty";
		displayName="TWC 1990 AmmoBox";
		class TransportMagazines
		{
			class _xx_UK3CB_BAF_556_30Rnd
			{
