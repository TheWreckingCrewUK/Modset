...
#undef CURRENT_VEHICLE
#define CURRENT_VEHICLE COLDWAR_WHIRLWIND_MOD
class INDO_H19;
class TWC_Vehicle_ColdWar_Whirlwind_RAF: INDO_H19 {
	scope = 2;
	scopeCurator = 2;
	side = 1;
	ADD_FACTION;
	
	displayname = "Whirlwind (RAF)";
	editorSubcategory = "TWC_ForceType_AirMobility";
	
	hiddenSelectionsTextures[] = {
		"INDO_Air\H19\data\SIRKH19_1_trans_co.paa",
		"TWC_Vehicles\data\raf_whirlwind_co.paa"
	};
...
class TWC_Vehicle_ColdWar_Whirlwind_RAF_COIN: TWC_Vehicle_ColdWar_Whirlwind_RAF {
	scope = 2;
	scopeCurator = 2;
	side = 1;
	ADD_FACTION;
	
	displayname = "Whirlwind - COIN (RAF)";
	editorSubcategory = "TWC_ForceType_AirMobility";
