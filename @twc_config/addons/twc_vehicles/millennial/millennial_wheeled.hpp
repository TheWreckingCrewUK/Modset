...
class TWC_Vehicle_Millennial_LandRover_Woodland: TWC_BaseClass_LR_Hard_Base_F {
	scope = 2;
	scopeCurator = 2;
	side = 1;
	ADD_FACTION;
...
class TWC_Vehicle_Millennial_LandRoverHard_Desert: TWC_Vehicle_ColdWar_LandRover_Woodland {
...
class TWC_Vehicle_Millennial_LandRoverHard_Desert_COIN: TWC_Vehicle_ColdWar_LandRoverHard_Woodland_COIN {
