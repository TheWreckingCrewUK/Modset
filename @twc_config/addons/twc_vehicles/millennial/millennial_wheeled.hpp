...
class TWC_Vehicle_Millennial_LandRoverSnatch_Woodland: TWC_BaseClass_LR_Snatch_Base_F {
	scope = 2;
	scopeCurator = 2;
	side = 1;
	ADD_FACTION;
	
	displayname = "Land Rover - Snatch (Woodland)";
	editorSubcategory = "TWC_ForceType_Motorised";
...
class TWC_Vehicle_Millennial_LandRoverSnatch_Desert: TWC_Vehicle_Millennial_LandRoverSnatch_Woodland {
	displayname = "Land Rover - Snatch (Desert)";
...
class TWC_Vehicle_Millennial_LandRoverSnatch_Woodland_COIN: TWC_BaseClass_LR_Snatch_Base_F {
	scope = 2;
	scopeCurator = 2;
	side = 1;
	ADD_FACTION;
	
	displayname = "Land Rover - Snatch COIN (Woodland)";
	editorSubcategory = "TWC_ForceType_Motorised";
...
class TWC_Vehicle_Millennial_LandRoverSnatch_Desert_COIN: TWC_Vehicle_Millennial_LandRoverSnatch_Woodland_COIN {
