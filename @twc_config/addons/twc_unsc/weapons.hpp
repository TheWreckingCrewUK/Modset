...
class TWC_Weapon_MA5CGL: OPTRE_MA5CGL {
	...
	class LinkedItems {
		class LinkedItemsOptic {
			slot = "asdg_OpticRail_OPTRE_MA5CGL";
			item = "optre_ma5c_smartlink";
		};
	};
};
class TWC_Weapon_MA5C: OPTRE_MA5C {
	scope = 1;
	class LinkedItems {
		class LinkedItemsOptic {
			slot = "asdg_OpticRail_OPTRE_MA5CGL";
...
class TWC_Weapon_BR55HB: OPTRE_BR55HB {
	...
	class LinkedItems {
		class LinkedItemsOptic {
			slot = "asdg_OpticRail_OPTRE_BR55HB";
...
class TWC_Weapon_M392: OPTRE_M392_DMR {
	...
	class LinkedItems {
		class LinkedItemsOptic {
			slot = "asdg_OpticRail_OPTRE_M32_DMR";
...
class TWC_Weapon_SRS99D: OPTRE_SRS99D {
	...
	class LinkedItems {
		class LinkedItemsOptic {
			slot = "asdg_OpticRail_OPTRE_SRS99D";
