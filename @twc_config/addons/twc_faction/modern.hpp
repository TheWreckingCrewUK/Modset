	...
	class Modern_British_Sniper: B_Soldier_base_F
	{
		_generalMacro="Modern_British_Sniper";
		scope=2;
	...
	class Modern_British_Spotter: B_Soldier_base_F
	{
		_generalMacro="Modern_British_Spotter";
		scope=2;
