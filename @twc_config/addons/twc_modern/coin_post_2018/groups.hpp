#define COIN_2018_GROUPS(CAMO) \
class TWC_Groups_Modern_2018_COIN_##CAMO \
{ \
	name = __EVAL("Infantry Post 2018(COIN, " + #CAMO + ")"); \
	class Section \
	{ \
		name = "Section"; \
		faction = "TWC_Modern"; \
		...
		{ \
			side = 1; \
			vehicle = TWC_Infantry_Modern_COIN_##CAMO##_Rifleman; \
			rank = "PRIVATE"; \
			position[] = {6,0,0}; \
		}; \
		class Unit4 \
...
{ \
	...
	{ \
		...
		{ \
			side = 1; \
			vehicle = TWC_Infantry_Modern_COIN_Dismounted_##CAMO##_Rifleman; \
			rank = "PRIVATE"; \
			position[] = {6,0,0}; \
		}; \
		class Unit4 \
...
COIN_2018_GROUPS(Woodland)
COIN_2018_GROUPS(NBC)
COIN_2018_GROUPS(Arctic)