#define 2018_REGULAR_GROUPS(CAMO) \
class TWC_Groups_Modern_2018_Regular_##CAMO \
{ \
	name = __EVAL("Infantry (Post 2018) (" + #CAMO + ")"); \
	class Section \
	{ \
		name = "Section"; \
		faction = "TWC_Modern"; \
...
2018_REGULAR_GROUPS(Woodland)
2018_REGULAR_GROUPS(NBC)
2018_REGULAR_GROUPS(Arctic)