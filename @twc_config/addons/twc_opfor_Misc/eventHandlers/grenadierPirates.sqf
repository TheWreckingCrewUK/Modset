...
switch (_gun)do{
	case "CUP_arifle_AK74_GL_Early": {_unit addWeapon "CUP_arifle_AK74_GL_Early"; _unit addMagazines ["CUP_30Rnd_545x39_AK_M",5]; _unit addMagazines ["CUP_1Rnd_HE_GP25_M",6]};
	case "CUP_arifle_AKM_GL_Early": {_unit addWeapon "CUP_arifle_AKM_GL_Early"; _unit addMagazines ["CUP_30Rnd_762x39_AK47_M",5]; _unit addMagazines ["CUP_1Rnd_HE_GP25_M",6]};
	case "CUP_arifle_AKMS_GL_Early": {_unit addWeapon "CUP_arifle_AKMS_GL_Early"; _unit addMagazines ["CUP_30Rnd_762x39_AK47_M",5]; _unit addMagazines ["CUP_1Rnd_HE_GP25_M",6]};
	case "CUP_arifle_AKS74_GL_Early": {_unit addWeapon "CUP_arifle_AKS74_GL_Early"; _unit addMagazines ["CUP_30Rnd_545x39_AK_M",5];};
	case "CUP_glaunch_M79": {_unit addWeapon "CUP_glaunch_M79"; _unit addMagazines ["CUP_1Rnd_HE_M203",5]; _unit addMagazines ["CUP_1Rnd_HE_GP25_M",6]; _unit addWeapon "CUP_hgun_Colt1911"; _unit addMagazines ["CUP_7Rnd_45ACP_1911",3]};
