...
//////////// Africans//////////
class RF_Afr_Pirate_Base: O_Soldier_base_F
{
	author="Saxon";
	scope=1;
	displayName="African Pirate Base";
	faction="TWC_Afr_Pirates_RF";
	nakedUniform="U_BasicBody";
	uniformClass="U_C_Poor_1";
	genericNames="AfroMen";
	identityTypes[]=
...
class RF_Afr_Pirate_Skipper: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Skipper";
	icon="iconManOfficer";
...
class RF_Afr_Pirate_Captain: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Cap'n";
	icon="iconManLeader";
...
class RF_Afr_Pirate_AK: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Pirate (AK)";
	uniformClass="U_I_C_Soldier_Bandit_1_F";
...
class RF_Afr_Pirate_AKM: RF_Afr_Pirate_AK
{
	scope=2;
	displayName="Pirate (AKM)";
	uniformClass="U_I_C_Soldier_Bandit_3_F";
...
class RF_Afr_Pirate_AKS: RF_Afr_Pirate_AKM
{
	scope=2;
	displayName="Pirate (AKS)";
	uniformClass="U_I_C_Soldier_Bandit_4_F";
...
class RF_Afr_Pirate_RPG: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="AT-Pirate";
	uniformClass="CUP_U_I_GUE_Anorak_01";
...
class RF_Afr_Pirate_AK74: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Pirate (AK-74)";
	uniformClass="CUP_U_I_GUE_Anorak_03";
...
class RF_Afr_Pirate_AKS74: RF_Afr_Pirate_AK74
{
	scope=2;
	displayName="Pirate (AKS-74)";
	uniformClass="U_I_C_Soldier_Para_2_F";
...
class RF_Afr_Pirate_AK74GP25: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Grenadier Pirate";
	uniformClass="U_I_C_Soldier_Bandit_1_F";
...
class RF_Afr_Pirate_FAL: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Pirate (FAL)";
	uniformClass="U_I_C_Soldier_Bandit_5_F";
...
class RF_Afr_Pirate_M14: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Pirate (M14)";
	uniformClass="U_I_C_Soldier_Bandit_2_F";
...
class RF_Afr_Pirate_SMLE: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Pirate (SMLE)";
	uniformClass="U_I_C_Soldier_Bandit_5_F";
...
class RF_Afr_Pirate_AR_RPD: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Auto Riflepirate (RPD)";
	uniformClass="U_I_C_Soldier_Bandit_2_F";
...
class RF_Afr_Pirate_AR_RPK: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Auto Riflepirate (RPK)";
	uniformClass="U_I_C_Soldier_Bandit_2_F";
...
class RF_Afr_Pirate_MG_M60: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="MG Pirate (M60)";
	uniformClass="U_I_C_Soldier_Para_3_F";
...
class RF_Afr_Pirate_MG_PKM: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="MG Pirate (PKM)";
	uniformClass="U_I_C_Soldier_Bandit_1_F";
...
class RF_Afr_Pirate_MM_SVD: RF_Afr_Pirate_Base
{
	scope=2;
	displayName="Markspirate (SVD)";
	uniformClass="U_I_C_Soldier_Camo_F";
...
class RF_Asn_Pirate_Skipper: RF_Afr_Pirate_Skipper
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
	{
		"LanguageCHI_F",
...
class RF_Asn_Pirate_Captain: RF_Afr_Pirate_Captain
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_AK: RF_Afr_Pirate_AK
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_AKS: RF_Afr_Pirate_AKS
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_AKM: RF_Afr_Pirate_AKM
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_RPG: RF_Afr_Pirate_RPG
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_AK74: RF_Afr_Pirate_AK74
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_AKS74: RF_Afr_Pirate_AKS74
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_AK74GP25: RF_Afr_Pirate_AK74GP25
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_FAL: RF_Afr_Pirate_FAL
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_M14: RF_Afr_Pirate_M14
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_SMLE: RF_Afr_Pirate_SMLE
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_AR_RPD: RF_Afr_Pirate_AR_RPD
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_AR_RPK: RF_Afr_Pirate_AR_RPK
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_MG_M60: RF_Afr_Pirate_MG_M60
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_MG_PKM: RF_Afr_Pirate_MG_PKM
{
	faction="TWC_Asn_Pirates_RF";
	genericNames="ChineseMen";
	identityTypes[] =
...
class RF_Asn_Pirate_MM_SVD: RF_Afr_Pirate_MM_SVD
{
