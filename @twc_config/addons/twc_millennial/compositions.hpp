class CfgGroups
{
        class WEST
        {
                ...
                class TWC_Operation_Blufor //Faction Class name
                {
						...
						class 1990_Artic
						{
								name = "TWC 1990 Artic Symetrical"; //Name of Sub Group - Infantry , SpecOps , Support , Motorized , Mechanized, Armored
                                class 1990_Section_Artic
                                {
                                        name = "Section"; //Name of Group
                                        faction = "TWC_Millenial"; //Faction
                                        side = 1; //Side
                                        ...
                                        {
                                                side = 1;
                                                vehicle = "1990_British_SectionCommander_Artic"; //Class name of desired solider
                                                rank = "SERGEANT"; // Rank
                                                position[] = {0,3,0}; //Position in the formation
                                        };
                                        class Unit1
                                        {
                                                side = 1;
                                                vehicle = "1990_British_Rifleman_Artic";
                                                rank = "PRIVATE";
                                                position[] = {3,0,0};
                                        };
                                        class Unit2
                                        {
                                                side = 1;
                                                vehicle = "1990_British_Rifleman_AT_Artic";
                                                rank = "PRIVATE";
                                                position[] = {5,0,0};
                                        };
										class Unit3
                                        {
                                                side = 1;
                                                vehicle = "1990_British_Gunner_Artic";
                                                rank = "PRIVATE";
                                                position[] = {7,0,0};
                                        };
										class Unit4
                                        {
                                                side = 1;
                                                vehicle = "1990_British_2IC_Artic";
                                                rank = "CORPORAL";
                                                position[] = {9,0,0};
                                        };
										class Unit5
								...
								class 1990_Platoon_Command_Artic
                                {
                                        name = "Platoon Command"; //Name of Group
                                        faction = "TWC_Millenial"; //Faction
                                        side = 1; //Side
                                        ...
                                        {
                                                side = 1;
                                                vehicle = "1990_British_Platoon_Commander_Artic"; //Class name of desired solider
                                                rank = "MAJOR"; // Rank
                                                position[] = {0,3,0}; //Position in the formation
                                        };
                                        class Unit1
                                        {
                                                side = 1;
                                                vehicle = "1990_British_Platoon_Sergeant_Artic";
                                                rank = "LIEUTENANT";
                                                position[] = {3,0,0};
                                        };
                                        class Unit2
                                        {
                                                side = 1;
                                                vehicle = "1990_British_Medic_Artic";
                                                rank = "PRIVATE";
                                                position[] = {5,0,0};
                                        };
										class Unit3
                                        {
                                                side = 1;
                                                vehicle = "1990_British_Platoon_CSM_Artic";
                                                rank = "CAPTAIN";
                                                position[] = {7,0,0};
                                        };
                                };
