...
{ \
	...
	{ \
		name = "Section (Mechanised Infantry)"; \
		faction = "TWC_Millennial"; \
		side = 1; \
		class Unit0 \
		{ \
...
{ \
	...
	{ \
		...
		{ \
			side = 1; \
			vehicle = TWC_Infantry_2000_Regular_Dismounted_##CAMO##_Grenadier; \
			rank = "PRIVATE"; \
			position[] = {2,0,0}; \
		}; \
		class Unit2 \
		{ \
			side = 1; \
			vehicle = TWC_Infantry_2000_Regular_Dismounted_##CAMO##_Autorifleman; \
			rank = "PRIVATE"; \
			position[] = {4,0,0}; \
		}; \
		class Unit3 \
		{ \
			side = 1; \
			vehicle = TWC_Infantry_2000_Regular_Dismounted_##CAMO##_Marksman; \
			rank = "PRIVATE"; \
			position[] = {6,0,0}; \
		}; \
		class Unit4 \
