...
/*class TWC_Infantry_2000_Regular_Tropic_Starstreak_Gunner: TWC_Infantry_2000_Regular_Woodland_Javelin_Gunner
{
	displayName = "Starstreak Gunner";
};
class TWC_Infantry_2000_Regular_Tropic_Starstreak_Ass: TWC_Infantry_2000_Regular_Woodland_Starstreak_Gunner
{
