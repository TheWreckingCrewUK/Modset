...
{
	CATEGORY(TWC_Infantry_2000_COIN_Woodland)
	Items[] =
	{
		MEDICAL_LOADOUT,
		MAG_2("ACE_CableTie")
...
//AT
class TWC_Infantry_2000_COIN_Woodland_Javelin_Gunner: TWC_Infantry_2000_Regular_Woodland_Javelin_Gunner
{
	CATEGORY(TWC_Infantry_2000_COIN_Woodland)
	items[] =
	{
...
class TWC_Infantry_2000_COIN_Woodland_Javelin_Ass: TWC_Infantry_2000_Regular_Woodland_Javelin_Ass
{
	CATEGORY(TWC_Infantry_2000_COIN_Woodland)
	items[] =
	{
